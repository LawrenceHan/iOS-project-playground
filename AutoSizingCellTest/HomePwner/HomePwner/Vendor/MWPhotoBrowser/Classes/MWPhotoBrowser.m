...
- (void)showGrid:(BOOL)animated {
    ...
    UIImageView *referencedView = [currentPage photoImageView];
    CGRect fromFrame = [referencedView.image tgr_aspectFitRectForSize:referencedView.bounds.size];
    ...
    // Add transition view
    UIImageView *transitionView = [[UIImageView alloc] initWithImage:referencedView.image];
...
- (void)hideGrid {
    ...
    CGRect toFrame = [fromImageView.image tgr_aspectFitRectForSize:self.view.frame.size];
