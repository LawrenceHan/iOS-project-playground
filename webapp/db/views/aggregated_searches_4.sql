CREATE OR REPLACE VIEW aggregated_searches AS
  SELECT
...
UNION
  SELECT
    ...
    hospitals.latitude AS latitude,
    hospitals.longitude AS longitude,
    physicians.avg_rating AS avg_rating,
    hospitals.h_class AS h_class,
    hospital_id,
    department_id,
...
UNION
  SELECT
    ...
    NULL::NUMERIC AS latitude,
    NULL::NUMERIC AS longitude,
    medications.avg_rating AS avg_rating,
    NULL::VARCHAR AS h_class,
    NULL::INTEGER AS hospital_id,
    NULL::INTEGER AS department_id,
    NULL::INTEGER AS speciality_id,
...
UNION
  SELECT
    ...
    hospitals.latitude AS latitude,
    hospitals.longitude AS longitude,
    hospitals.avg_rating AS avg_rating,
    NULL::VARCHAR AS h_class,
    hospitals.id AS hospital_id,
    NULL::INTEGER AS department_id,
    NULL::INTEGER AS speciality_id,
